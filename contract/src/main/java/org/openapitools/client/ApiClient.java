...
public class ApiClient {
    ...
    private String basePath = "https://api.esgi.fr/refcontract/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("ApiKey", new ApiKeyAuth("header", "X-OKAPI-KEY"));
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://moncompte/esgi.fr/oauth/token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.esgi.fr/refcontract/v1
