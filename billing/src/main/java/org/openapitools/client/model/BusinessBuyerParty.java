...
public class BusinessBuyerParty extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(BusinessBuyerParty.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!BusinessBuyerParty.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'BusinessBuyerParty' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<BusinessBuyerParty>() {
                @Override
                public void write(JsonWriter out, BusinessBuyerParty value) throws IOException {
                ...
                @Override
                public BusinessBuyerParty read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        BusinessBuyerParty ret = new BusinessBuyerParty();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for BusinessBuyerParty: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public BusinessBuyerParty() {
        super("oneOf", Boolean.FALSE);
    }

    public BusinessBuyerParty(BusinessParticularParty o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public BusinessBuyerParty(BusinessProfessionnalParty o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return BusinessBuyerParty.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BusinessBuyerParty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for BusinessBuyerParty with oneOf schemas: BusinessParticularParty, BusinessProfessionnalParty. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of BusinessBuyerParty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BusinessBuyerParty
  * @throws IOException if the JSON string is invalid with respect to BusinessBuyerParty
  */
  public static BusinessBuyerParty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BusinessBuyerParty.class);
  }

 /**
  * Convert an instance of BusinessBuyerParty to an JSON string
  *
  * @return JSON string
  */
